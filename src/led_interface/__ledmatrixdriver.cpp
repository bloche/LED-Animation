 ...
 */
LEDMatrixDriver::LEDMatrixDriver(VideoReaderDelegate* reader,QObject *parent) :
    LEDDriver(parent)
{
#ifndef USE_STD_OUT
    #ifdef DEBUG
    ...
    printf("before other class load\n");
    this->matrixCount = 1;
    printf("1\n");
    ...
    this->videoReader->setBuffer(this->buffer);
    printf("10\n");
    this->frameCount = 0;
    printf("before lookup table\n");
...
*/
printf("Ending constructor of LEDMatrix Driver\n");
}
